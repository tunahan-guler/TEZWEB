...
import { bridge as schema } from '../Collection/uniform/GraphqlSchema';
import {
  AddOrUpdateEnum, useAcAccountdocumenthMutateMutation, useGetAcAccountdocumenthsTableQuery, useGetStakeholdersLazyQuery,
...
import GetAcAccountDocumentIs from '../Collection/SubComponnents/GetAcAccountDocumentIs';
          ...
          <div>
            <Card variant='outlined' sx={{
              ...
              <CardContent>
                ...
                <ErrorField name={'stakeholder'} errorMessage={t('PleaseSelectSupplier')} />
                <Grid container spacing={1}>
                  ...
                  <Grid item xs={12} sm={12} lg={6} md={6}>
                    <TextLabelField name={'stakeholder.stakeholdername'} label={t('suppliername')}
                      disabled={getViewModeEx === 2 ? false : true}
                  ...
                  <Grid item xs={12} sm={12} lg={6} md={6}>
                    <AutoLabelField name={'stakeholder.stakeholdercode'} label={'suppliercode'} disabled />
                  </Grid>
                  <Grid item xs={12} sm={6} lg={6}>
