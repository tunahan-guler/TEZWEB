...
const GetGoodsReceivingIs = ({ value, onChange, getViewModeEx }) => {
    ...
    return (
        < >
            <MSCTableRowField >
                ...
                <MSCTableCell name={'rstat'} options={[{ label: t("Accept"), value: "A" }, { label: t("Reject"), value: "R" }]} disabled={false} />
            ...
            <MSCTableRowField>
                <TableCell style={{ border: '0.5px solid #DCDCDC', height: '0', padding: '0px 16px 0px 16px' }} padding='0' colSpan={'100%'}>
                    ...
                    <ErrorField name={'rstat'} errorMessage={t('Accept/RejectIsRequired')} />
                </TableCell>
            </MSCTableRowField>
        </>
    )
...
export default connectField(GetGoodsReceivingIs)