...
import { TextField, ListDelField, HiddenField } from 'uniforms-material'
...
const GetItem = ({ onChange, value, getViewModeEx }) => {
    ...
    return (
        <>
            {/* <HiddenField name={'createtime'} value={moment().format()}/>
        <HiddenField name={'changetime'} value={moment().format()}/> */}
                            ...
                            {/* <HiddenField name={'invoiceno'} value={0} />
                                ...
                                <TableCell align="center" style={{ border: '0.5px solid #DCDCDC', height: '5', padding: 0 }}  >
                                    <ListDelField name="" size={'small'} variant="standard" InputProps={{ disableUnderline: true }}
                                        style={{ padding: "0px 5px", margin: "0px" }} disabled={getViewModeEx === 2 ? false : true} />
                                </TableCell> */}
                            {/* </MSCTableRowField> */}
                        </MSCTableField>
                    </Collapse>
