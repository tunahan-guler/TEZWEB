...
function NavbarStyle1Content(props) {
  ...
  return (
    <Root className={clsx('flex flex-auto flex-col overflow-hidden h-full', props.className)}>
      ...
      >
      <div className="flex flex-1 mx-4">
        <Root className="flex items-center" style={{ justifyContent: 'center', alignItems: 'center', display: 'flex', width: '100%' }}>
          <img className="logo-icon w-100 h-36" src="assets/images/logos/fuse.svg" alt="logo" />
        </Root>
      </div>
      </AppBar>
    </Root>
